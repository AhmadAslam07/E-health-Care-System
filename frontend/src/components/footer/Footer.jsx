    ...
    <>
     ...
     <footer className="text-center text-lg-start  text-white footer">
          ...
          <div className="container text-center text-md-start mt-5">
            ...
            <div className="row mt-3">
              ...
              <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                ...
                <p>
                 We assure that you can have the best Healthcare facility at your home, providing the specialist doctors for you.
                </p>
              </div>
              {/* Grid column */}
              {/* Grid column */}
              ...
              <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                ...
                <p><FaMapMarkerAlt/> &nbsp; Fareed town Sahiwal</p>
                <p>
                  <FaEnvelope /> &nbsp; 
                  ranaahmadaslam@gmail.com
                </p>
                <p><FaMobileAlt/> &nbsp;  03143696063</p>
              </div>
              {/* Grid column */}
            </div>
            {/* Grid row */}
        ...
        <div className="text-center p-4" style={{backgroundColor: 'rgba(0, 0, 0, 0.05)'}}>
          © 2025 Copyright version (0.0.7): 
          <a className="text-reset fw-bold" href="#!"> E-HealthCare</a>
        </div>
        {/* Copyright */}
      </footer>
    </>
